...
const INITIAL_LOGS: LogEntry[] = [
  {
    ...
    status: 'Dispatched',
    details: 'Block Kit alert posted to #security-alerts for Supabase table isolation (Score: 2/10)',
    durationMs: 84,
  },
  {
    id: 'log_02',
    ...
    stage: 'AI Inference',
    status: '200 OK',
    details: 'OpenAI gpt-4o-mini audited Supabase schema and flagged cross-tenant exposure risk',
    durationMs: 142,
  },
  {
    id: 'log_03',
    ...
    stage: 'Dedupe',
    status: '200 OK',
    details: 'MFA compliance check verified on all active developer accounts (6/6 accounts active)',
    durationMs: 3,
  },
  {
    id: 'log_04',
    ...
    stage: 'Ingestion',
    status: '200 OK',
    details: 'Polled AWS RDS security configurations (HTTP 200). 1 policy matched trigger "hardcoded key"',
    durationMs: 310,
  },
  {
    id: 'log_05',
    ...
    stage: 'Dedupe',
    status: 'Blocked',
    details: 'Identical scan payload sha256:7f9a2b8c91 exists. Halting execution to prevent alert fatigue.',
    durationMs: 2,
  },
  {
    id: 'log_06',
    ...
    stage: 'AI Inference',
    status: 'Filtered',
    details: 'Classified RDS configuration as compliant with SOC 2 CC6.3. Below alert threshold.',
    durationMs: 118,
  },
];
