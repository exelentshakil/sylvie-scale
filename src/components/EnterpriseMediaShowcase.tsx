  ...
  const architecturalPillars = [
    {
      ...
      tag: 'Vanta & Drata Compliance',
      title: 'SOC 2 Automated Control Mapping',
      description: 'Pre-mapped Common Criteria policies and continuous evidence collection, accelerating auditor readiness and eliminating manual compliance overhead.',
    },
    {
      id: 'pillar-infrastructure',
      tag: 'Multi-Tenant Security',
      title: 'Supabase Postgres RLS Isolation',
      description: 'Strict Row Level Security policies verified via automated integration tests, preventing tenant data crossover and securing enterprise user payloads.',
    },
    {
      id: 'pillar-ai',
      tag: 'Dual LLM Circuit Breaker',
      title: 'High-Availability AI Failover Routing',
      description: 'OpenAI GPT-4o with instant 1500ms circuit breaker tripping to Google Gemini 2.0 Flash, ensuring users never see a loading hang during critical inferences.',
    },
  ];
          ...
          <div className="rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] overflow-hidden shadow-2xs hover:shadow-xs transition-shadow mb-8">
            <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-900">
              ...
              <img
                ...
                alt="High-performance compliance and security monitoring interface"
            ...
            <div className="p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div className="space-y-1 max-w-2xl">
                ...
                <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] opacity-85 leading-relaxed">
                  Eliminated security liabilities and scale bottlenecks through automated compliance controls, private ML guardrails, and automated failover circuit breakers.
                </p>
              </div>
