...
const STATS: BackboneStat[] = [
  {
    value: '100%',
    label: 'SOC 2 Common Criteria controls mapped, with gaps prioritized',
    color: '#533AFD',
    sparkline: [
      { t: 'Q1', v: 22.4 },
      { t: 'Q2', v: 28.5 },
  ...
  {
    value: '5 Days',
    label: 'from initial onboarding to functional CI/CD and deployment pipelines',
    color: '#057A55',
    sparkline: [
      { t: 'Stage 1', v: 1.0 },
      { t: 'Stage 2', v: 2.4 },
  ...
  {
    value: '99.98%',
    label: 'uptime achieved through OpenAI and Gemini high-availability failover routing',
    color: '#D97706',
    domain: [97.5, 100],
    sparkline: [
      { t: 'W1', v: 98.1 },
  ...
  {
    value: 'sub-15ms',
    label: 'database response times enforced via EXPLAIN (ANALYZE, BUFFERS) optimization',
    color: '#0d9488',
    domain: [0, 52],
    sparkline: [
      { t: 'Run 1', v: 48.0 },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-[-0.025em] text-[var(--color-text-primary)]">
            The backbone of secure, enterprise-ready scale
          </h2>
          <p className="mt-2 text-base text-[#2E3C4E] dark:text-slate-300 leading-relaxed">
            Rigorous security policies, optimized model pipelines, and high-velocity engineering processes.
          </p>
        </div>
