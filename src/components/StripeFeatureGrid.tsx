...
const FEATURES: FeatureItem[] = [
  {
    ...
    description: 'Get tailored architectural guidance from senior systems engineers on LLM model selection, database scalability, and automated SOC 2 compliance readiness.',
  ...
  },
  {
    ...
    description: 'Receive ongoing operational monitoring, Inngest background event queues, automated dual-provider model failover, and strict 99.999% SLA response tracking.',
